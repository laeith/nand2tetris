   ...
   Some directories:
      ...
      Also, this part is a bit different directory wise from the course one because I wanted to make it a little more meaningful and potentially expand a few gates.
         - Gates:
            - Implemented gates: 
